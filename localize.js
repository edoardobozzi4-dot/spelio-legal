(function () {
  ...
  var en = {
    'meta.home.title': 'Spelio | Budget planner for iOS and Android',
    'meta.home.description': 'Spelio is the budgeting app for planning income, expenses, budgets and savings goals ahead of time. Available for iOS and Android.',
    ...
    'home.hero.eyebrow': 'Spelio · Clear budgeting, calmer decisions',
    'home.hero.title': "Don't just track your spending. Plan it.",
    'home.hero.lede': 'Plan your income, expenses, budget and savings goals ahead of time, all in one simple app.',
    'home.hero.primaryCta': 'Explore the app',
    'home.hero.secondaryCta': 'See Premium',
    'home.hero.trustAria': 'Key points',
    'home.hero.trust.monthly': 'Monthly planning',
    'home.hero.trust.goals': 'Savings goals',
    'home.hero.trust.premium': 'Premium available on App Store and Google Play',
    ...
    'download.mid.eyebrow': 'Start planning',
    'download.mid.title': 'Your next month starts today.',
    'download.mid.text': 'Download Spelio free on iOS or Android.',
    ...
    'download.text': 'Download Spelio from the official stores.',
    'download.aria': 'Download Spelio app',
    'download.google': 'Google Play',
    'download.apple': 'Apple App Store',
    'store.apple.asset': 'assets/store-badges/app-store-en.svg',
    'store.apple.alt': 'Download on the App Store',
    'store.apple.aria': 'Download Spelio on the App Store',
    'store.google.asset': 'assets/store-badges/google-play-en.png',
    'store.google.alt': 'Get it on Google Play',
    'store.google.aria': 'Get Spelio on Google Play',
